...
#        self.store[(frozenset(array_to_cards(hand.data.numpy())), frozenset(array_to_cards(board.data.numpy())))] = HS.data.numpy()
#        path = 'data\featurizer.p'
#        with open(path, 'wb') as f:
#                pickle.dump(self.store, f)
        if len(array_to_cards(board.data.numpy())) > 0:
            print("Cards : ", array_to_cards(hand.data.numpy()), "Board : ", array_to_cards(board.data.numpy()), "HS : ", HS)
